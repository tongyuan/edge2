...
USER edge2
CMD ["sh", "-c", "node tests/test_operator_time.js && node tests/test_heatmap_state.js && node tests/test_monitor_presentation.js && node tests/test_activation_feasibility.js && python3 -m unittest discover -s tests -v"]
