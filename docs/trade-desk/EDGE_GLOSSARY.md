...
`dealingRangeHigh`, and `activeDealingRangeAvailable`. These are legacy/internal
names for midpoint-based MRZ structural geometry. They do not establish a
mandate-level trading dealing range.
