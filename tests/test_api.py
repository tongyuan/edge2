...
class APIIntegrationTests(unittest.TestCase):
    ...
    def test_mrz_formation_diagnostics_page_keeps_compatible_route(self) -> None:
        ...
        self.assertIn('id="qualificationCount"', response.text)
        self.assertIn('id="qualificationHistoryView"', response.text)
        self.assertIn("?view=qualification-history", response.text)
        self.assertIn('id="productionSampleContent"', response.text)
        self.assertNotIn('id="qualificationContent"', response.text)
        self.assertNotIn("Qualified under production rule", response.text)
