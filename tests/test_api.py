...
class APIIntegrationTests(unittest.TestCase):
    ...
    def test_activation_feasibility_page_is_private_routed_and_complete(self) -> None:
        ...
        self.assertIn('id="matrixA"', response.text)
        ...
        self.assertIn("Algorithm A scenario results", response.text)
        self.assertIn('id="diagnosisSummaryContent"', response.text)
        self.assertIn('id="decisionSupportContent"', response.text)
        self.assertIn("PRODUCTION ACTIVATION SUMMARY", response.text)
